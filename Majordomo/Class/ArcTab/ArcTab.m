...
- (void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation
  ...
  UIButton * selectedButton = (UIButton *)[self viewWithTag:kNArcTabSelectedItemTag];
...
- (void)_dimAllButtonsExcept:(UIButton *)selectedButton {
  for (UIButton * button in buttons_) {
    if (button == selectedButton) {
      ...
      [button setTag:kNArcTabSelectedItemTag];
...
//    |  |
//    v  | <------- |tabBarHalfHeight|
// ---a-------- <-- bottom of window (equal to |kViewHeight|)
// \     |
